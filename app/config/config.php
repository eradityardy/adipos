...
|
*/
$config['encryption_key'] = 'P693iJKS1Akdl0tywmXUfqbMjEcsoe';
...
$config['sess_cookie_name'] = 'izi_session';
...
$config['csrf_token_name'] = 'izi_token';
$config['csrf_cookie_name'] = 'izi_cookie';
