...
<div class="wrapper rtl rtl-inv">
    ...
    <header class="main-header">
        <a href="<?= site_url(); ?>" class="logo">
            ...
            <span class="logo-lg"><?= $store->name == 'AikoGamis' ? 'Aiko<b>Gamis</b>' : $store->name; ?></span>
            <?php } else { ?>
            <span class="logo-mini">GLNI</span>
            <span class="logo-lg"><?= $Settings->site_name == 'AikoGamis' ? 'Aiko<b>Gamis</b>' : $Settings->site_name; ?></span>
            <?php } ?>
        </a>
                            ...
                            <li>
                                <ul class="menu">
                                    ...
                                    foreach ($suspended_sales as $ss) {
                                        echo '<a href="'.site_url('pos/?hold='.$ss->id).'" class="load_suspended">'.$this->izi->hrld($ss->date).' ('.$ss->customer_name.')<br><strong>'.$ss->hold_ref.'</strong></a>';
                                    }
                                    ?>
                                    </li>
                                </ul>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview mm_sales">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="divider"></li>
                        <li id="sales_retur"><a href="<?= site_url('retursales'); ?>"><i class="fa fa-circle-o"></i> <?= lang('list_retursales'); ?></a></li>
                        <li id="sales_add_retur"><a href="<?= site_url('retursales/add_retur'); ?>"><i class="fa fa-circle-o"></i> <?= lang('add_retursales'); ?></a></li>
                    </ul>
                </li>
