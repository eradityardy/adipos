...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#RSLData').DataTable({

            'ajax' : { url: '<?=site_url('retursales/get_retur');?>', type: 'POST', "data": function ( d ) {
            ...
            <div class="box box-primary">
                <div class="box-body">
                    <div class="table-responsive">
                        <table id="RSLData" class="table table-striped table-bordered table-condensed table-hover">
                            <thead>
                                <tr class="active">
                                    <th style="max-width:30px;"><?= lang("id"); ?></th>
                                    <th class="col-xs-2"><?= lang("date"); ?></th>
                                    <th class="col-xs-2"><?= lang("customer"); ?></th>
                                    <th class="col-xs-1"><?= lang("no_retur"); ?></th>
                                    <th class="col-xs-1"><?= lang("exno_transaksi"); ?></th>
